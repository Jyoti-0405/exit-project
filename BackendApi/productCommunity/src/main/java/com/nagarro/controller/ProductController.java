 ...
 */
 ...
 public void insertProduct(@RequestBody Product product) throws Exception
 {
	...
	Product productObj=service.getProduct(brand);
 ...
 public Product getProductById(@PathVariable("id") String brand) throws Exception
 {
	try {
	return this.service.getProduct(brand);
	}
	catch(Exception e)
	{
